...
class RunControllerTest {
    ...
    void shouldCreateNewRun() throws Exception {
        var run = new Run(3,"test", LocalDateTime.now(),LocalDateTime.now().plus(30, ChronoUnit.MINUTES),1, Location.INDOOR, null);
    ...
    void shouldUpdateRun() throws Exception {
        var run = new Run(1,"test", LocalDateTime.now(),LocalDateTime.now().plus(30, ChronoUnit.MINUTES),1, Location.INDOOR, null);
